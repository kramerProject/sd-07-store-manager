...
const errors = {
  ...
  lowQauntity: '"quantity" must be larger than or equal to 1',
  quantityAsNuber: '"quantity" must be a number',
  productExists: 'Product already exists',
  wrongId: 'Wrong id format',
  wrongIdOrQuantity: 'Wrong product ID or invallid quantity',
